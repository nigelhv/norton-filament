...
{
    use SoftDeletes;
    // public $with = ['activities', 'location'];
    ...
    protected static function boot()
    {
        ...
        static::addGlobalScope(new OnRollScope);
    ...
    {
        $start_date = (new \App\MyDate)->yearStartDate();
    ...
    public function activitiesWithFilter($start_date, $end_date, $subject_filter = null)
    {
        ...
        $filtered_activities=$activities->filter(function($activity) use($subject_filter ){ return $activity->hasSubject($subject_filter);});
    ...
    {
        $activities = \App\Activity::whereHas('subjects', function ($query) {
    ...
    public function attendancesThisWeek($date=null)
    {
        $attendances=Attendance::where('student_id', $this->id)
            ->where('date', '>=', (new \App\MyDate($date))
                ->thisMonday())
            ->where('date', '<=', (new \App\MyDate($date))
                ->thisFriday())
            ->get();
    ...
    public function totalAttendances($date=null)
        {
            if($date == null)
            {
                $date=(new \App\MyDate)->yearStartDate();
                // $date = '2018-09-01';
            }
    ...
    public function totalAttendanceRecords($date=null)
    {
        ...
        return  \App\Attendance::where('student_id', $this->id)
            ->where('date', '>=', $date)
            ->count();
    ...
    public function delWeeklyActivitiesCount($date=null)
    {
        ...
        $weekbeginning = (new \App\MyDate($date))->thisMonday($date);
   ...
   public function getWeeklyActivitiesCount($date=null)
    {
        ...
        $weekbeginning = (new \App\MyDate($date))->thisMonday();
   ...
   public function getWeeklyEcActivitiesCount($date=null)
    ...
    public function getActivitiesOn($date)
    {
        ...
        return $activities->filter(function($activity) use ($date){
            return $activity->date->toDateString() == $date;
        });
    }
    ...
    {
        $monday = (new \App\MyDate($date))->thisMonday();
    ...
    {
        $monday = (new \App\MyDate($weekbeginning))->thisMonday();
        if(!$inc){
            $inc=1;
        }
    ...
    {
        $total_activities           = $student->getWeeklyActivitiesCount();
        $total_english_extra_credit = $student->getWeeklyEecCount();
        $total_maths_extra_credit   = $student->getWeeklyMecCount();
    ...
    public function getThisWeeksMathsActivitiesCount($date=null)
    {
        ...
        return $activities->sum(function($activity){ return $activity->subjects->where('name', 'Maths')->count(); });
